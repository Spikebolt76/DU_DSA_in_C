...
/// @brief To copy whole linkedlist to other linkedlist.
/// @param list Pointer to the Original LinkedList.
/// @param copy Pointer to the LinkedList you are going to copy to.
void copyList(LinkedList* list, LinkedList* copy) {
    Node* curr = list->head;
    while (curr != NULL) {
        insertAtEnd(copy, curr->data); 
        curr = curr->next;
    }
}
